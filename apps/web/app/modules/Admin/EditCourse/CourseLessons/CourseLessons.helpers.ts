...
export const mapQuestionTypeToLabel = (questionType: QuestionType): string =>
  match(questionType)
    ...
    .with(QuestionType.MULTIPLE_CHOICE, () => "adminCourseView.curriculum.lesson.other.multipleChoice")
    .with(QuestionType.TRUE_OR_FALSE, () => "adminCourseView.curriculum.lesson.other.trueOrFalse")
    .with(QuestionType.BRIEF_RESPONSE, () => "adminCourseView.curriculum.lesson.other.briefResponse")
    .with(QuestionType.DETAILED_RESPONSE, () => "adminCourseView.curriculum.lesson.other.detailedResponse")
    .with(QuestionType.PHOTO_QUESTION_SINGLE_CHOICE, QuestionType.PHOTO_QUESTION_MULTIPLE_CHOICE, () => "adminCourseView.curriculum.lesson.other.photoQuestion")
    .with(QuestionType.FILL_IN_THE_BLANKS_TEXT, () => "adminCourseView.curriculum.lesson.other.fillInTheBlanksText")
    .with(QuestionType.FILL_IN_THE_BLANKS_DND, () => "adminCourseView.curriculum.lesson.other.fillInTheBlanks")
