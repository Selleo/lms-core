...
export const mapQuestionTypeToLabel = (questionType: QuestionType): string =>
  match(questionType)
    ...
    .with(QuestionType.PHOTO_QUESTION_SINGLE_CHOICE, () => "Photo Question Single Choice")
    .with(QuestionType.PHOTO_QUESTION_MULTIPLE_CHOICE, () => "Photo Question Multiple Choice")
