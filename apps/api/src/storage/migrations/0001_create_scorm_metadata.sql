CREATE TABLE IF NOT EXISTS "scorm_files" (
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "scorm_metadata" ADD CONSTRAINT "scorm_metadata_file_id_scorm_files_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."scorm_files"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
